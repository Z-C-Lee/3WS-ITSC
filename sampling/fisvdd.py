...
class fisvdd:
    def __init__(self, data, sigma, eps_cp=1e-8, eps_ol=1e-8):
        ...
        self.sv = np.array(self.data[0][0].reshape(1, self.data[0][0].shape[1]))
    ...
    def find_sv(self):
        ...
        for index, new_data in enumerate(self.data[1:]):
            ...
            new_data = new_data[0].reshape((1,new_data[0].shape[1]))
...
if __name__ == "__main__":
    dataFile = r'D:\My_Code\Python\reduction\data\tool\data.mat'
